...
symbol_boxes = {key: OffsetImage(image, zoom=0.017) for key, image in symbols.items()}
...
with tab4:
    ...
    specials_settings_column_config = {
    ...
    specials_summary = st.data_editor(specials_summary, use_container_width=True, column_config=specials_settings_column_config)
    ...
    circumstances_summary_column_config = {
        "kind": st.column_config.TextColumn(label="Situation", disabled = True),
